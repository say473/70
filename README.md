...
<body>
<h1>OnlyFANS</h1>
<h4><ins>Verifications to get your Profile : </ins>
<p>Hello Catalin Lulian Borous we are doing this to make sure its you. You have to pay the sum of €499:00
...
<br>get your profile  done. Your Contents are going to get uploaded within 24 hours
...
<body>
    ...
    <script>
        function proceedToPayment() {
            alert("verify your profile through the admin to proceed.");
        }
    </script>
